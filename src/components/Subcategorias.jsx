...
const Subcategorias = () => {
    ...
    const cadastrarSubcategoria = (event) => {
        ...
        api.post("/subcategorias/create", {
            ...
            setSnackbar({
                open: true,
                message: getApiErrorMessage(error, "Não foi possível cadastrar a subcategoria."),
                severity: "error",
            })
        }).finally(function () {
            setLoading(false)
    ...
    const deletarSubcategoria = () => {
        ...
        api.delete(`/subcategorias/${id}`, {
            ...
            setSnackbar({
                open: true,
                message: getApiErrorMessage(error, "Não foi possível excluir a subcategoria."),
                severity: "error",
            })
        }).finally(function () {
            setDeleting(false)
                            ...
                            {subcategorias.length === 0 && (
                                ...
                                >
                                    ...
                                    <Typography variant="body2" sx={{ color: "text.secondary" }}>
                                        Cadastre subcategorias para detalhar a classificação dos conteúdos.
                                    </Typography>
                                </Box>
                            )}
                        </Box>
