...
const Instrutores = () => {
  ...
  const handleOpenMenu = (event, instrutor) => {
    setMenuAnchor(event.currentTarget);
    setMenuInstrutor(instrutor);
  };

  const handleCloseMenu = () => {
    setMenuAnchor(null);
    setMenuInstrutor(null);
  };
  ...
  return (
    <Box sx={{ border: `1px solid ${theme.palette.divider}`, borderRadius: 2,bgcolor:theme.palette.secondary.light  }}>
                ...
                <TableRow key={instrutor.id ?? instrutor.email} hover>
                  ...
                  <TableCell align="right">
                    <IconButton
                      ...
                      onClick={(event) => handleOpenMenu(event, instrutor)}
                      aria-controls={isMenuOpen ? "instrutor-actions-menu" : undefined}
                      aria-haspopup="true"
      ...
      >
        ...
        <MenuItem onClick={handleDeleteInstrutor} sx={{ color: "error.main" }}>
